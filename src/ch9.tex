...
\Exercise{16} Show that $\phi(mn) > \phi(m)\phi(n)$ if $m$ and $n$
...
\Exercise{17} Show that $(m,n) = 2$ implies $\phi(mn) = 2\phi(m)\phi(n)$.
\begin{proof}
...
\Exercise{18} Show that $\phi(n) = n/2$ if and only if $n = 2^k$ for
