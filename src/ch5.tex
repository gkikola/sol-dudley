...
\Problem{17} If $x\equiv r\pmod{m}$ and $x\equiv s\pmod{m+1}$, show
that
\begin{equation*}
...
\Problem{18} What three positive integers, upon being multiplied by
...
\Problem{19} Suppose that the moduli in the system
\begin{equation*}
...
\Problem{20} How many multiples of $b$ are there in the sequence
\begin{equation*}
  a, 2a, 3a, \dots, ba?
\end{equation*}
\begin{solution}
